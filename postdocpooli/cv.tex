...
\href{http://www.aalto.fi/}{Aalto University}  \href{http://www.aalto.fi/}{School of Science} &  \\
FI-02150 Espoo, Finland  & \textit{Phone:} +358 40 179 5220 \\
\textit{Homepage:} http://users.ics.aalto.fi/kcho/ & \textit{E-mail:}
...
\item[] Visiting Researcher,
        \href{http://lisa.iro.umontreal.ca/}, Aug 2013--Feb 2014 
        \begin{innerlist}
...
\item[] Ph.D. Candidate,
        \href{http://ics.aalto.fi/en}, May 2011--March 2014 (\textit{planned})
        \begin{innerlist}
...
\item[] M.Sc. with distinction (GPA: 4.68/5, Thesis: 5/5),
        \href{http://ics.aalto.fi/en}, Aug 2009--April 2011
        \begin{innerlist}
        \item Supervisor: Prof. Juha Karhunen
...
%\section{Highlighted Publication}
%%
...
%\item \textbf{Thesis} SDN: The Next Generation CDN Technology Ð On-demand Web-based Service Delivery
...
\hfill \textbf{September 2009}
\begin{outerlist}

\item[] \textit{President}%
\begin{innerlist}
\item Sep 2011--Aug 2012
\end{innerlist}
\item[] \textit{Chief Coordinator of External Affairs}%
\begin{innerlist}
\item Sep 2010--Aug 2011
\end{innerlist}
%
