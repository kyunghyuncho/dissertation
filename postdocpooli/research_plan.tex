...
networks already from 1980s and has continued working on deep
...
2003, Prof. Bengio proposed the first language modeling techinque
...
already from early 1990s \citep[see,
e.g.,][]{Bengio1994}.
...
sequentially from the begging to the end to summarize the
...
word embeddings descrbied in Sec.~\ref{sec:biembed}. 
...
the convenitonal system also focuses more on learning
...
million word occurrences for each langauage. Each language has
