...
principal component analysis (PCA\nomenclature{PCA}{Principal
component analysis}) which may be considered a
...
perceptron} (MLP\nomenclature{MLP}{Multi-layer perceptron}) \citep[see, e.g.,][and references
...
using Bayesian optimization \citep[see, e.g.,][and
references therein]{Brochu2010}. Bayesian optimization
